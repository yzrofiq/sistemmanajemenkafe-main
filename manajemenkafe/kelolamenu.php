...
$query = "SELECT menu_id, nama_menu, foto_produk, harga, deskripsi FROM menu";
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td><img src="img/<?php echo htmlspecialchars($row['foto_produk']); ?>" alt="Foto Produk"></td>
                            <td><?php echo 'Rp ' . number_format($row['harga'], 0, ',', '.'); ?></td>
                            <td><?php echo htmlspecialchars($row['deskripsi']); ?></td>
                            <td>
                                <a href="editmenu.php?id=<?php echo $row['menu_id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" onclick="showConfirmation(<?php echo $row['menu_id']; ?>)">Delete</a>
...
function deleteItem() {
  window.location.href = 'hapus_menu.php?id=' + idToDelete;
}
</script>
