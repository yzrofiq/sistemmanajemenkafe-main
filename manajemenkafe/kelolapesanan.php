...
<body>
    ...
    <div class="content" id="content">
        ...
        <main>
            <h2>Kelola Pesanan Cafe</h2>
            <div class="mb-3">
                <a href="tambahpesanan.php" class="btn btn-primary">Tambah Data</a>
            </div>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($row['menudibeli']); ?></td>
                            <td><?php echo htmlspecialchars($row['nama_pelanggan']); ?></td>
                            <td><?php echo htmlspecialchars($row['nama_metode']); ?></td>
                            <td>
                                <a href="editpesanan.php?id=<?php echo $row['order_id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" onclick="showConfirmation(<?php echo $row['order_id']; ?>)">Delete</a>
...
function deleteItem() {
  window.location.href = 'hapus_pesanan.php?id=' + idToDelete;
}
</script>
