...
<body>
    ...
    <div class="content" id="content">
        ...
        <main>
        <h2>Tambah Jadwal Reservasi Baru</h2>
<form action="prosestambahreservasi.php" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
        ...
        <input type="date" class="form-control" id="jadwal_reservasi" name="jadwal_reservasi" required>
    </div>
    <div class="mb-3">
    ...
    <input type="submit" class="btn btn-primary" value="Tambah Jadwal Reservasi"></input>
</form>
