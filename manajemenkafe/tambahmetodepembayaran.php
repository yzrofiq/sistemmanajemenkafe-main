...
<form action="prosestambahpembayaran.php" method="POST" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="kategori_metode" name="kategori_metode" required>
    ...
    <div class="mb-3">
        ...
        <input type="file" class="form-control" id="logo_metode" name="logo_metode" required>
    </div>
 
    <input type="submit" class="btn btn-primary" value="Tambah Metode Pembayaran"></input>
</form>
