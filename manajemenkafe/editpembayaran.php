...
<body>
    ...
    <form action="proseseditpembayaran.php?id=<?php echo $id_metode; ?>" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="nama_metode" class="form-label">Nama Metode</label>
            <input type="text" class="form-control" id="nama_metode" name="nama_metode" value="<?php echo $row['nama_metode']; ?>" >
        </div>
        <div class="mb-3">
            <label for="kategori_metode" class="form-label">Kategori Metode</label>
            <select class="form-select" id="kategori_metode" name="kategori_metode" >
                <option value="">Pilih Kategori Metode</option>
                <option value="BANK" <?php if ($row['kategori_metode'] == 'BANK') echo 'selected'; ?>>BANK</option>
                <option value="e-Wallet" <?php if ($row['kategori_metode'] == 'e-Wallet') echo 'selected'; ?>>e-Wallet</option>
            </select>
        </div>
        <div class="mb-3">
            <label for="logo_metode" class="form-label">Logo Metode</label>
            <input type="file" class="form-control" id="logo_metode" name="logo_metode" >
            <img src="img/<?php echo $row['logo_metode']; ?>" alt="<?php echo $row['nama_metode']; ?>" class="img-thumbnail mt-2" style="max-width: 150px;">
        </div>
 
        <input type="submit" class="btn btn-primary" value="Edit Metode Pembayaran"></input>
    </form>
</main>
