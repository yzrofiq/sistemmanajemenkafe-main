...
$query = "SELECT id_metode,nama_metode,kategori_metode,logo_metode  FROM metodepembayaran";
...
<body>
    ...
    <div class="content" id="content">
        ...
        <main>
            <h2>Kelola Daftar Metode Pembayaran</h2>
            <div class="mb-3">
                <a href="tambahmetodepembayaran.php" class="btn btn-primary">Tambah Data</a>
            </div>
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($row['id_metode']); ?></td>
                            <td><?php echo htmlspecialchars($row['nama_metode']); ?></td>
                            <td><?php echo htmlspecialchars($row['kategori_metode']); ?></td>
                            <td><img src="img/<?php echo htmlspecialchars($row['logo_metode']); ?>" alt="Foto Produk"></td>
                           
                            <td>
                                <a href="editpembayaran.php?id=<?php echo $row['id_metode']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="#" class="btn btn-danger btn-sm" data-bs-toggle="modal" onclick="showConfirmation(<?php echo $row['id_metode']; ?>)">Delete</a>
...
function deleteItem() {
  window.location.href = 'hapus_metode.php?id=' + idToDelete;
}
</script>
